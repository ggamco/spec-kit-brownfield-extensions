...
This extension provides tools that extend the standard spec-kit SDD workflow for brownfield projects:

```
┌─────────────────────────────────────────────────────────────────────────────────┐
│                     Extended SDD Workflow for Brownfield Projects                │
├─────────────────────────────────────────────────────────────────────────────────┤
│                                                                                  │
│   [Existing Project]                                                             │
│         │                                                                        │
...
│   │ bootstrap.init              │     │ (Generate Developer Skills) │           │
│   │ (Bootstrap SDD Workflow)    │     └─────────────────────────────┘           │
│   └───────────┬─────────────────┘                                               │
│               │                                                                  │
│               ▼                                                                  │
│   ┌─────────────────────────────┐     ┌─────────────────────────────┐           │
│   │ User Requirements           │────▶│ brownfield-ears             │  Optional │
...
|------|------|---------|-------------|
| `/speckit.brownfield-bootstrap.init` | Extension Command | Initialize SDD for existing projects | First time adopting spec-kit |
| `brownfield-skills` | Skill | Generate senior developer expertise | Enable AI to master project conventions |
| `brownfield-ears` | Skill | Convert requirements to EARS format | Before `/speckit.specify` for complex requirements |
